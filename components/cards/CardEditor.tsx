        ...
        <form ref={formRef} action={formAction} className="w-full max-w-full flex flex-col items-center gap-6">
          ...
          >
            ...
            >
              ...
              <CardHeader label="Question" deckName={deck.title} ink={ink} />
              <textarea
                ref={questionRef}
                name="question"
            ...
            >
              <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: PAPER_NOISE, mixBlendMode: 'multiply', opacity: 0.5 }} />
              <CardHeader label="Answer" deckName={deck.title} ink={ink} />
              <textarea
                ref={answerRef}
...
function CardHeader({ label, deckName, ink }: { label: string; deckName: string; ink: string }) {
  return (
    <div className="flex items-center justify-between px-5 py-3 shrink-0" style={{ borderBottom: `1px solid ${ink}20` }}>
